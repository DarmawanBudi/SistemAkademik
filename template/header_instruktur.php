          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../kelas/data_kelas.php?kls='Reguler'"><i class="fa fa-circle-o text-red"></i> <span>Reguler</span></a></li>
                <li><a href="../kelas/data_kelas.php?kls='Privat'"><i class="fa fa-circle-o text-yellow"></i> <span>privat</span></a></li>
                <li><a href="../kelas/data_kelas.php?kls='Profesi'"><i class="fa fa-circle-o text-green"></i> <span>Profesi</span></a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>privat</span></a></li>
