          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../role/data_role.php"><i class="fa fa-shield"></i> Role</a></li>
                <li><a href="../instruktur/data_instruktur.php"><i class="fa fa-user"></i> Instruktur</a></li>
                <li><a href="../karyawan/data_karyawan.php"><i class="fa fa-user"></i> karyawan</a></li>
                <li><a href="../program/data_program.php"><i class="fa fa-user"></i> Program</a></li>
              </ul>
            </li>
