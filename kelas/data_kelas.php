            ...
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                  ...
                  if ($_SESSION['id_role']!="R0010")
                  {
                  $queryview = mysqli_query($koneksi, "SELECT a.id_kelas as id_kelas, a.id_program as id_prog, b.*, c.*, d.*, e.* FROM kelas a, program b, waktu c, ruang d, instruktur e where a.id_program=b.id_program and a.id_waktu=c.id_waktu and a.id_ruang=d.id_ruang and a.id_instruktur=e.id_instruktur and a.keterangan_kelas=$_GET[kls] and e.username=$_SESSION[username] order by id_kelas asc");
                  // a.keterangan_kelas=$_GET[kls] untuk memilih jenis keterangan kelas (keterangan_kelas di database instruktur)
                  // e.username=$_SESSION[username] = supaya saat instruktur login hanya menampilkan program yang diampu
                  }
                  else
                  {
