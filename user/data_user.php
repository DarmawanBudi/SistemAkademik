          ...
          <div class="table-responsive22">
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                  <?php
                    $no = 1;
                    $queryview = mysqli_query($koneksi, "SELECT * FROM user");
                    while ($row = mysqli_fetch_assoc($queryview)) {
                  ?>
                  <tr>
                    <td><?php echo $no++;?></td>
                    <td><?php echo $row['id_user'];?></td>
                    <td><?php echo $row['id_akaryawan'];?></td>
                                ...
                                <form action="../user/function_user.php?act=updateuser" method="post" role="form">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      ...
                                      <div class="col-sm-8">
                                      <input type="text" class="form-control" name="id_user" placeholder="Id User" value="<?php echo $row['id_user']; ?>"></div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
